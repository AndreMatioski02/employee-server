        ...
        security
            ...
            .authorizeHttpRequests { requests ->
                requests
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/employee")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/employee/login")).permitAll()
